...
Impl <img src=images/programming-language-file.svg height = 18> | Name | Ubuntu 18.04 | Later Ubuntu | Fedora | Description
---- | -- |--------------------------- | - | - | -----------
...
<img src=images/rustacean.svg height=18/> | [starship](https://starship.rs/) | [Install Fira Code Nerd Font](https://github.com/tonsky/FiraCode/wiki/Linux-instructions#installing-with-a-package-manager); Set as font in terminal application; [Set as font in VS Code](https://github.com/tonsky/FiraCode/wiki/VS-Code-Instructions); Follow *Quick Install* instructions using shell script. Copy *.config/starship.toml* to *~/.config* | same | same | Amazing developer-friendly, colorful, and rich shell prompt.
