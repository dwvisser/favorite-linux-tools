...
<img src=images/rustacean.svg height=18/> [bat](https://github.com/sharkdp/bat) | On Ubuntu 20.04 and newer, just `apt install bat` (tool is invoked with `batcat` in this case). Otherwise, use dpkg (see below) | Colorful `cat` with line numbers, paging, and syntax highlighting.
